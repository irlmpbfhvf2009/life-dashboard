export default {
  ...
  voice: { unsupported: 'เบราว์เซอร์นี้ไม่รองรับการรู้จำเสียง จึงสลับเป็นพิมพ์ข้อความ แนะนำ Chrome หรือ Edge บนเดสก์ท็อปเพื่อใช้ฟีเจอร์พูดเต็มรูปแบบ', stop: 'หยุด', hold: 'กดเพื่อพูด', micUnsupported: 'เบราว์เซอร์นี้ไม่รองรับการป้อนด้วยเสียง' },
  ...
  mission: { title: 'ภารกิจวันนี้', sub: 'รักษาจังหวะการเรียนวันนี้', doneN: '{done} / {total} เสร็จ' },
