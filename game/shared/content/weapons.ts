...
export const WEAPONS: WeaponData[] = [
  ...
  {
    id: 'knife', name: '忍·飛刃', category: 'ranged', behavior: 'projectile', charId: 'assassin_sprout',
    description: '疾擲的忍者飛刃；擊殺後進入 1.2 秒狂熱，攻速大幅提升。',
  ...
  {
    id: 's_iai', name: '木刀·居合', category: 'melee', behavior: 'melee', charId: 'samurai_tomato',
    description: '看似人畜無害的木刀，一記居合半月斬；「先手一刀」對滿血敵人傷害 +60%。',
  ...
  // ── 修羅武僧專屬 gear（exclusiveGear：只有他能取得，見 characters.ts）
  {
    id: 'mk_chi', name: '氣彈', category: 'magic', behavior: 'projectile', charId: 'monk_tofu',
    description: '推出一顆凝勁氣彈，命中震開敵人、可貫穿一名。',
    base: { damage: 12, cooldown: 0.7, range: 340, projectileCount: 1, pierce: 1, knockback: 60, speed: 520 },
    perLevel: { damage: 4, knockback: 8 },
    maxLevel: 5, tags: ['chi', 'magic'], price: 12, tier: 1, palette: ['#bfe3ff', '#5a9fd6'],
  },
  {
    id: 'mk_quake', name: '震地', category: 'melee', behavior: 'melee', charId: 'monk_tofu',
    description: '踏地掀起氣勁，橫掃四周敵人並大力擊退。',
    base: { damage: 18, cooldown: 1.1, range: 150, projectileCount: 1, pierce: 99, knockback: 120, radius: 150 },
    perLevel: { damage: 6, radius: 8 },
    maxLevel: 5, tags: ['melee', 'chi'], price: 14, tier: 1, palette: ['#e0c9a0', '#a07a3d'],
  },
  {
    id: 'mk_guard', name: '護體真氣', category: 'support', behavior: 'healPulse', charId: 'monk_tofu',
    description: '運轉護體真氣，週期回復自己並灼傷貼身敵人。',
    base: { damage: 6, cooldown: 3.2, range: 180, projectileCount: 1, pierce: 0, knockback: 0, heal: 8 },
    perLevel: { heal: 3, damage: 2, cooldown: -0.2 },
    maxLevel: 5, tags: ['support', 'heal', 'chi'], price: 14, tier: 1, palette: ['#c9f5d0', '#5db87a'],
  },
  {
  ...
  // ── 致敬型技能英雄的招牌武器（2026-07-11；charId 綁本人）
  {
    id: 'be_kiwave', name: '元氣波', category: 'magic', behavior: 'projectile', charId: 'bean_saiyan',
    description: '推出一道貫穿一整列的鬥氣光波；每穿過一個敵人，傷害遞增 12%。',
    base: { damage: 15, cooldown: 1.0, range: 460, projectileCount: 1, pierce: 4, knockback: 40, speed: 640 },
    perLevel: { damage: 6, pierce: 1 },
    mech: { id: 'pierceRamp', params: { per: 0.12 } },
    evolution: { requires: 'ch_bean', into: 'be_nova' },
    maxLevel: 5, critModifier: 1.6, tags: ['chi', 'magic', 'pierce'], price: 12, tier: 1, palette: ['#ffe082', '#ff8f00'],
  },
  // ── 金剛毛豆專屬 gear（exclusiveGear：爆氣戰鬥種族一整套招式，只有他能取得）
  {
    id: 'be_barrage', name: '連珠氣彈', category: 'magic', behavior: 'projectile', charId: 'bean_saiyan',
    description: '極速連射的小型鬥氣彈，微微追向敵人；越練彈幕越密。',
    base: { damage: 6, cooldown: 0.3, range: 380, projectileCount: 2, pierce: 0, knockback: 15, speed: 620 },
    perLevel: { damage: 2, projectileCount: 0.34, cooldown: -0.01 },
    mech: { id: 'homing', params: { turn: 4 } },
    maxLevel: 5, tags: ['chi', 'magic', 'rapid'], price: 14, tier: 1, palette: ['#ffe082', '#ffab00'],
  },
  {
    id: 'be_rush', name: '崩拳連打', category: 'melee', behavior: 'melee', charId: 'bean_saiyan',
    description: '疾衝而入的鬥氣連拳；每第 5 拳灌氣轟出震盪拳勁，範圍與傷害大增。',
    base: { damage: 12, cooldown: 0.5, range: 110, projectileCount: 1, pierce: 99, knockback: 90, radius: 100 },
    perLevel: { damage: 5, radius: 6, knockback: 8 },
    mech: { id: 'comboNova', params: { every: 5, radiusMult: 1.8, dmgMult: 1.8 } },
    maxLevel: 5, critModifier: 1.5, tags: ['melee', 'fist', 'chi'], price: 12, tier: 1, palette: ['#ffd54f', '#8bc34a'],
  },
  {
    id: 'be_spirit', name: '元氣彈', category: 'magic', behavior: 'projectile', charId: 'bean_saiyan',
    description: '蓄力射出一顆巨大的元氣球，飛得慢卻沉重；落地炸開一整片、藍白光華四射，對菁英與 Boss 傷害 +40%。冷卻長，一發定生死。',
    base: { damage: 40, cooldown: 3.2, range: 460, projectileCount: 1, pierce: 0, knockback: 160, speed: 230, radius: 190 },
    perLevel: { damage: 16, radius: 14 },
    mech: { id: 'bossKiller', params: { mult: 1.4 } },
    maxLevel: 5, specialEffect: 'explode', tags: ['chi', 'magic', 'explosive'], price: 22, tier: 2, palette: ['#e3f2fd', '#2196f3'],
  },
  {
    id: 'be_aura', name: '鬥氣爆震', category: 'melee', behavior: 'melee', charId: 'bean_saiyan',
    description: '瞬間爆氣震開四周敵人；掃到的敵人越多、這一震越痛（每個 +8%）。',
    base: { damage: 16, cooldown: 1.3, range: 170, projectileCount: 1, pierce: 99, knockback: 200, radius: 175 },
    perLevel: { damage: 6, radius: 10, knockback: 12 },
    mech: { id: 'crowdBonus', params: { per: 0.08, cap: 0.8 } },
    maxLevel: 5, tags: ['melee', 'chi', 'knockback'], price: 18, tier: 2, palette: ['#fff59d', '#f9a825'],
  },
  {
    id: 'ca_football', name: '烈焰足球', category: 'ranged', behavior: 'projectile', charId: 'cabbage_striker',
    description: '踢出會自動轉彎追人、命中即爆的火焰足球，炸飛一小片敵人。',
    base: { damage: 13, cooldown: 0.85, range: 400, projectileCount: 1, pierce: 0, knockback: 90, speed: 500, radius: 72 },
    perLevel: { damage: 5, radius: 6 },
    mech: { id: 'homing', params: { turn: 4 } },
    evolution: { requires: 'ch_cab', into: 'ca_meteor' },
    maxLevel: 5, specialEffect: 'explode', tags: ['bullet', 'explosive'], price: 14, tier: 1, palette: ['#fafafa', '#212121'],
  },
  {
    id: 'cf_jab', name: '搓招連段', category: 'melee', behavior: 'melee', charId: 'chili_boxer',
    description: '街機格鬥的搓招連段：輕拳→輕拳→重勾拳三段循環。前兩段極快、小範圍打點；第三段收招重擊，範圍與傷害暴增並把敵人擊飛。',
    base: { damage: 9, cooldown: 0.5, range: 95, projectileCount: 1, pierce: 99, knockback: 40, radius: 82 },
    perLevel: { damage: 3, cooldown: -0.02, radius: 4 },
    mech: { id: 'comboChain', params: { jab: 0.9, heavy: 2.6, heavyR: 1.5, jabCd: 0.42, heavyCd: 1.5, heavyKb: 4 } },
    evolution: { requires: 'ch_chili', into: 'cf_dragon' },
    maxLevel: 5, critModifier: 1.5, tags: ['melee', 'fist'], price: 12, tier: 1, palette: ['#e53935', '#ffca28'],
  },
  ...
  },
  {
    ...
    description: '繞身高速旋踢的烈焰腿影，把貼近的敵人一路踹開；越練腿影越多。',
    base: { damage: 10, cooldown: 1.0, range: 0, projectileCount: 2, pierce: 99, knockback: 90, radius: 110, speed: 3.6 },
    perLevel: { damage: 4, projectileCount: 0.5, radius: 8 },
    maxLevel: 5, tags: ['melee', 'fist', 'orbit'], price: 18, tier: 2, palette: ['#ff7043', '#bf360c'],
  },
  {
    id: 'cf_sweep', name: '掃堂腿', category: 'melee', behavior: 'melee', charId: 'chili_boxer',
    description: '低身橫掃一大圈；30% 機率把小怪絆倒（暈眩）。',
    base: { damage: 15, cooldown: 1.2, range: 150, projectileCount: 1, pierce: 99, knockback: 110, radius: 155 },
    perLevel: { damage: 6, radius: 10 },
    mech: { id: 'stunHit', params: { chance: 0.3, dur: 0.7 } },
    maxLevel: 5, tags: ['melee', 'fist'], price: 18, tier: 2, palette: ['#ef5350', '#b71c1c'],
  },
  {
    id: 'cf_bodyblow', name: '崩山重擊', category: 'melee', behavior: 'melee', charId: 'chili_boxer',
    description: '蓄力轟出的貼身鐵拳；「處決」——對生命低於 30% 的敵人傷害翻倍。',
    base: { damage: 26, cooldown: 1.5, range: 105, projectileCount: 1, pierce: 99, knockback: 140, radius: 100 },
    perLevel: { damage: 10, radius: 6 },
    mech: { id: 'execute', params: { below: 0.3, mult: 2 } },
    maxLevel: 5, critModifier: 1.5, tags: ['melee', 'fist', 'heavy'], price: 20, tier: 2, palette: ['#e53935', '#4e342e'],
  },
  {
    id: 'gh_wisp', name: '幽冥彈', category: 'magic', behavior: 'projectile', charId: 'ghost_shroom',
    description: '拋出一團自動飄向目標的怨靈鬼火；造成傷害的 15% 化為自己的生命。',
    base: { damage: 11, cooldown: 0.7, range: 380, projectileCount: 1, pierce: 1, knockback: 15, speed: 440 },
    perLevel: { damage: 4 },
    mech: { id: 'lifesteal', params: { pct: 0.15 } },
    evolution: { requires: 'ch_ghost', into: 'gh_reaper' },
    maxLevel: 5, critModifier: 1.6, tags: ['magic', 'spore', 'heal'], price: 12, tier: 1, palette: ['#b39ddb', '#4527a0'],
  },
  {
    id: 'lk_arc', name: '雷刃', category: 'magic', behavior: 'chain', charId: 'leek_bolt',
    description: '射出在敵群間跳躍的雷刃電弧，越練跳得越多。',
    base: { damage: 9, cooldown: 0.9, range: 340, projectileCount: 1, pierce: 0, knockback: 0, chains: 3, radius: 170 },
    perLevel: { damage: 3, chains: 1 },
    evolution: { requires: 'ch_leek', into: 'lk_storm' },
    maxLevel: 5, tags: ['lightning', 'magic'], price: 12, tier: 1, palette: ['#fff176', '#fbc02d'],
  },
  {
    id: 'vm_fang', name: '蝠翼鏢', category: 'ranged', behavior: 'projectile', charId: 'eggplant_vampire',
    description: '擲出迴旋的蝠翼鏢；造成傷害的 15% 化為自己的生命。',
    base: { damage: 12, cooldown: 0.75, range: 360, projectileCount: 1, pierce: 1, knockback: 20, speed: 600 },
    perLevel: { damage: 4 },
    mech: { id: 'lifesteal', params: { pct: 0.15 } },
    evolution: { requires: 'ch_vamp', into: 'vm_nightwing' },
    maxLevel: 5, critModifier: 1.6, tags: ['crit', 'heal'], price: 12, tier: 1, palette: ['#7b1fa2', '#4a148c'],
  },
  {
    id: 'av_orb', name: '念力球', category: 'magic', behavior: 'projectile', charId: 'avocado_esper',
    description: '射出緩速、自動追蹤的念力球，貫穿並擊退敵人。',
    base: { damage: 13, cooldown: 0.9, range: 360, projectileCount: 1, pierce: 2, knockback: 60, speed: 360 },
    perLevel: { damage: 5, pierce: 1 },
    mech: { id: 'homing', params: { turn: 5 } },
    evolution: { requires: 'ch_esper', into: 'av_collapse' },
    maxLevel: 5, tags: ['magic'], price: 12, tier: 1, palette: ['#aed581', '#558b2f'],
  },
  {
    id: 'as_blade', name: '疾風刃', category: 'melee', behavior: 'melee', charId: 'asparagus_blademaster',
    description: '快如疾風的拔刀斬；每第 4 刀爆發一記橫掃亂舞，範圍與傷害大增。',
    base: { damage: 12, cooldown: 0.42, range: 120, projectileCount: 1, pierce: 99, knockback: 70, radius: 105 },
    perLevel: { damage: 4, cooldown: -0.02, radius: 5 },
    mech: { id: 'comboNova', params: { every: 4, radiusMult: 1.7, dmgMult: 1.7 } },
    evolution: { requires: 'ch_blade', into: 'as_tempest' },
    maxLevel: 5, critModifier: 1.8, tags: ['melee', 'crit'], price: 12, tier: 1, palette: ['#eceff1', '#78909c'],
  },
  {
    id: 'cg_revolver', name: '左輪快槍', category: 'ranged', behavior: 'projectile', charId: 'corn_gunslinger',
    description: '拔槍神速的左輪；每第 4 發必定暴擊，發發致命。',
    base: { damage: 11, cooldown: 0.55, range: 440, projectileCount: 1, pierce: 0, knockback: 40, speed: 680 },
    perLevel: { damage: 4, cooldown: -0.03 },
    mech: { id: 'critEvery', params: { n: 4 } },
    evolution: { requires: 'ch_corn', into: 'cg_peacemaker' },
    maxLevel: 5, critModifier: 1.9, tags: ['bullet', 'crit'], price: 12, tier: 1, palette: ['#ffd54f', '#6d4c2b'],
  },
  {
    id: 'ms_spawner', name: '孢子砲塔', category: 'engineer', behavior: 'turret', charId: 'mushroom_summoner',
    description: '佈署自動掃射的孢子砲塔（最多 2 座），召喚流的核心。',
    base: { damage: 7, cooldown: 5.5, range: 320, projectileCount: 1, pierce: 0, knockback: 20, speed: 540, duration: 10 },
    perLevel: { damage: 2.5, duration: 1.5 },
    evolution: { requires: 'ch_summon', into: 'ms_myconet' },
    maxLevel: 5, tags: ['engineer', 'summon', 'spore'], price: 16, tier: 1, palette: ['#ba68c8', '#5d4037'],
  },
  {
    id: 'pc_hourglass', name: '時砂彈', category: 'magic', behavior: 'projectile', charId: 'pitaya_chronos',
    description: '射出的時砂彈命中即拖慢敵人的時間流，重度減速。',
    base: { damage: 10, cooldown: 0.85, range: 360, projectileCount: 1, pierce: 1, knockback: 20, speed: 460, slow: 0.5, duration: 2.5 },
    perLevel: { damage: 4, slow: 0.05 },
    evolution: { requires: 'ch_chrono', into: 'pc_eon' },
    maxLevel: 5, tags: ['magic', 'frost'], price: 12, tier: 1, palette: ['#f48fb1', '#ad1457'],
  },
  {
    id: 'pa_bow', name: '三連弓', category: 'ranged', behavior: 'projectile', charId: 'pea_archer',
    description: '一次搭三箭齊射的獵弓，覆蓋面極廣。',
    base: { damage: 8, cooldown: 0.7, range: 400, projectileCount: 3, pierce: 1, knockback: 30, speed: 640 },
    perLevel: { damage: 3, projectileCount: 0.5 },
    evolution: { requires: 'ch_arch', into: 'pa_stormvolley' },
    maxLevel: 5, critModifier: 1.5, tags: ['bullet', 'spread', 'pierce'], price: 12, tier: 1, palette: ['#8d6e63', '#c5e1a5'],
  },
  {
    id: 'gp_hammer', name: '聖光槌', category: 'melee', behavior: 'melee', charId: 'garlic_paladin',
    description: '揮下聖光重槌，30% 機率把小怪打暈。',
    base: { damage: 18, cooldown: 1.1, range: 120, projectileCount: 1, pierce: 99, knockback: 180, radius: 115 },
    perLevel: { damage: 7, radius: 6, knockback: 15 },
    mech: { id: 'stunHit', params: { chance: 0.3, dur: 0.7 } },
    evolution: { requires: 'ch_pala', into: 'gp_dawnbringer' },
    maxLevel: 5, tags: ['melee', 'support'], price: 12, tier: 1, palette: ['#fff8e1', '#ffd700'],
  },
  // ---------------------------------------------------------- 睏寶：六個炸彈模組
  ...
  // ============================================================ 舊制角色→致敬克隆的專屬 gear（exclusiveGear：只有本人能取得）
  // ── 浪人番茄（銀魂式木刀浪人）：搭配簽名 s_iai（木刀·居合）
  {
    id: 'st_sweep', name: '木刀·橫薙', category: 'melee', behavior: 'melee', charId: 'samurai_tomato',
    description: '一記大開大闔的橫薙；掃到的敵人越多、這一刀越痛（每個 +8%）。',
    base: { damage: 18, cooldown: 1.0, range: 150, projectileCount: 1, pierce: 99, knockback: 100, radius: 150 },
    perLevel: { damage: 7, radius: 10 },
    mech: { id: 'crowdBonus', params: { per: 0.08, cap: 0.8 } },
    maxLevel: 5, critModifier: 1.6, tags: ['melee', 'crit'], price: 16, tier: 1, palette: ['#e2402f', '#8d6e63'],
  },
  {
    id: 'st_thrust', name: '木刀·刺突', category: 'melee', behavior: 'projectile', charId: 'samurai_tomato',
    description: '低身突刺的木刀，貫穿成排敵人；越練刺得越深。',
    base: { damage: 16, cooldown: 0.85, range: 260, projectileCount: 1, pierce: 3, knockback: 60, speed: 640 },
    perLevel: { damage: 6, pierce: 1 },
    maxLevel: 5, critModifier: 1.6, tags: ['melee', 'pierce'], price: 14, tier: 1, palette: ['#e2402f', '#c9a227'],
  },
  {
    id: 'st_flurry', name: '亂打連斬', category: 'melee', behavior: 'melee', charId: 'samurai_tomato',
    description: '看似懶散的木刀連斬；每第 8 斬突然認真起來，轟出毀滅性一擊。',
    base: { damage: 9, cooldown: 0.4, range: 120, projectileCount: 1, pierce: 99, knockback: 40, radius: 100 },
    perLevel: { damage: 3, cooldown: -0.02, radius: 4 },
    mech: { id: 'comboNova', params: { every: 8, radiusMult: 2, dmgMult: 2 } },
    maxLevel: 5, critModifier: 1.7, tags: ['melee', 'crit'], price: 12, tier: 1, palette: ['#e2402f', '#eceff1'],
  },
  {
    id: 'st_toss', name: '木刀擲擊', category: 'melee', behavior: 'projectile', charId: 'samurai_tomato',
    description: '把木刀甩出去砸人，命中後彈向最近的下一個敵人（最多 2 跳）。',
    base: { damage: 14, cooldown: 0.9, range: 360, projectileCount: 1, pierce: 0, knockback: 40, speed: 620 },
    perLevel: { damage: 5 },
    mech: { id: 'ricochet', params: { jumps: 2 } },
    maxLevel: 5, critModifier: 1.6, tags: ['melee', 'crit'], price: 16, tier: 2, palette: ['#a5231b', '#8d6e63'],
  },
  // ── 影忍豆芽（忍者·影分身流）：搭配簽名 knife
  {
    id: 'nj_shuriken', name: '手裏劍環', category: 'ranged', behavior: 'orbit', charId: 'assassin_sprout',
    ...
    maxLevel: 5, critModifier: 2.0, tags: ['crit', 'orbit'], price: 18, tier: 2, palette: ['#c5e1a5', '#455a64'],
  },
  {
    id: 'nj_kunai', name: '連環苦無', category: 'ranged', behavior: 'projectile', charId: 'assassin_sprout',
    description: '擲出的苦無命中後彈射到最近的下一個敵人（最多 2 跳）。',
    base: { damage: 10, cooldown: 0.6, range: 360, projectileCount: 1, pierce: 0, knockback: 20, speed: 660 },
    perLevel: { damage: 4 },
    mech: { id: 'ricochet', params: { jumps: 2 } },
    maxLevel: 5, critModifier: 1.6, tags: ['crit'], price: 16, tier: 2, palette: ['#7cb342', '#212121'],
  },
  {
    id: 'nj_clone', name: '影分身', category: 'summon', behavior: 'drone', charId: 'assassin_sprout',
    description: '分出一個影分身跟著你，自動朝附近敵人擲出苦無——不用瞄準的第二把手。',
    base: { damage: 6, cooldown: 0.65, range: 300, projectileCount: 1, pierce: 0, knockback: 10, speed: 620 },
    perLevel: { damage: 2, cooldown: -0.05 },
    maxLevel: 5, tags: ['summon', 'crit'], price: 20, tier: 2, palette: ['#aed581', '#33691e'],
  },
  {
    id: 'nj_rasen', name: '螺旋衝', category: 'melee', behavior: 'melee', charId: 'assassin_sprout',
    description: '掌心凝出高速旋轉的螺旋氣球，貼身轟出——單體爆發極高、大力擊飛。',
    base: { damage: 22, cooldown: 1.0, range: 80, projectileCount: 1, pierce: 99, knockback: 180, radius: 75 },
    perLevel: { damage: 8, radius: 5, knockback: 12 },
    maxLevel: 5, critModifier: 1.6, tags: ['melee', 'chi'], price: 18, tier: 2, palette: ['#4fc3f7', '#f9a825'],
  },
  {
    id: 'nj_rasenshuri', name: '螺旋手裏劍', category: 'magic', behavior: 'projectile', charId: 'assassin_sprout',
    description: '擲出的螺旋風刃貫穿敵陣、命中炸開，撕裂的風痕持續切割（2 秒）。',
    base: { damage: 20, cooldown: 1.4, range: 400, projectileCount: 1, pierce: 2, knockback: 60, speed: 560, radius: 90 },
    perLevel: { damage: 8, radius: 8, pierce: 1 },
    mech: { id: 'dotHit', params: { pct: 0.3, dur: 2 } },
    maxLevel: 5, critModifier: 1.6, specialEffect: 'explode', tags: ['crit', 'pierce'], price: 22, tier: 3, palette: ['#81d4fa', '#0277bd'],
  },
  // ── 盾衛地瓜（盾之勇者式盾衛）：搭配簽名 w_sword（劍與盾）
  {
    id: 'sw_bash', name: '盾擊', category: 'melee', behavior: 'melee', charId: 'warrior_sweetpotato',
    description: '用盾面猛撞——全場最強擊飛，30% 機率把小怪撞暈。',
    base: { damage: 18, cooldown: 1.2, range: 120, projectileCount: 1, pierce: 99, knockback: 200, radius: 110 },
    perLevel: { damage: 7, knockback: 20, radius: 8 },
    mech: { id: 'stunHit', params: { chance: 0.3, dur: 0.6 } },
    maxLevel: 5, tags: ['melee', 'knockback'], price: 16, tier: 1, palette: ['#c97b3d', '#90a4ae'],
  },
  {
    id: 'sw_thornguard', name: '反擊盾', category: 'melee', behavior: 'melee', charId: 'warrior_sweetpotato',
    description: '帶尖釘的盾牌回擊；每命中一個敵人就長出 0.5 點護盾（上限 20）。',
    base: { damage: 15, cooldown: 0.8, range: 100, projectileCount: 1, pierce: 99, knockback: 90, radius: 95 },
    perLevel: { damage: 6, radius: 6, knockback: 10 },
    mech: { id: 'thornShield', params: { amount: 0.5, cap: 20 } },
    maxLevel: 5, tags: ['melee', 'thorn'], price: 14, tier: 1, palette: ['#c97b3d', '#607d8b'],
  },
  {
    id: 'sw_barrier', name: '護盾結界', category: 'engineer', behavior: 'zone', charId: 'warrior_sweetpotato',
    description: '在腳下展開護盾結界，每次脈衝刺傷並把圈內敵人推開——會走路的防線。',
    base: { damage: 5, cooldown: 2.4, range: 300, projectileCount: 1, pierce: 0, knockback: 0, radius: 120, duration: 4, burn: 8 },
    perLevel: { burn: 3, radius: 10 },
    mech: { id: 'pulseZone', params: { kb: 200 } },
    maxLevel: 5, tags: ['zone', 'knockback'], price: 18, tier: 2, palette: ['#c97b3d', '#90caf9'],
  },
  {
    id: 'sw_aegis', name: '護盾光環', category: 'support', behavior: 'healPulse', charId: 'warrior_sweetpotato',
    description: '展開護盾光環，週期回復自己並灼傷貼身敵人。',
    base: { damage: 6, cooldown: 3.2, range: 180, projectileCount: 1, pierce: 0, knockback: 0, heal: 8 },
    perLevel: { heal: 3, damage: 2, cooldown: -0.2 },
    maxLevel: 5, tags: ['support', 'heal'], price: 16, tier: 2, palette: ['#ffd54f', '#c97b3d'],
  },
  ...
  // ── 致敬型技能英雄的進化武器（招牌武器滿級＋精通 → 中場自動進化）
  {
    id: 'be_nova', name: '超新星氣浪', category: 'magic', behavior: 'projectile', charId: 'bean_saiyan', evolvedForm: true,
    description: '元氣波的最終形態——貫穿全場的滅世光波，每穿一個敵人傷害遞增 20%。',
    base: { damage: 40, cooldown: 0.85, range: 560, projectileCount: 1, pierce: 8, knockback: 60, speed: 760 },
    perLevel: {},
    mech: { id: 'pierceRamp', params: { per: 0.2 } },
    maxLevel: 1, critModifier: 1.7, tags: ['chi', 'magic', 'pierce'], price: 45, tier: 3, palette: ['#fff59d', '#ff6f00'],
  },
  {
    id: 'ca_meteor', name: '流星射門', category: 'ranged', behavior: 'projectile', charId: 'cabbage_striker', evolvedForm: true,
    description: '烈焰足球的最終形態——追蹤更狠、爆炸更大的熾焰流星球。',
    base: { damage: 34, cooldown: 0.7, range: 440, projectileCount: 1, pierce: 0, knockback: 130, speed: 560, radius: 110 },
    perLevel: {},
    mech: { id: 'homing', params: { turn: 6 } },
    maxLevel: 1, specialEffect: 'explode', tags: ['bullet', 'explosive'], price: 45, tier: 3, palette: ['#ff7043', '#212121'],
  },
  {
    id: 'cf_dragon', name: '真·連環昇龍拳', category: 'melee', behavior: 'melee', charId: 'chili_boxer', evolvedForm: true,
    description: '連環刺拳的最終形態——每第 4 拳轟出毀天滅地的橫掃勾拳。',
    base: { damage: 22, cooldown: 0.26, range: 105, projectileCount: 1, pierce: 99, knockback: 60, radius: 110 },
    perLevel: {},
    mech: { id: 'comboNova', params: { every: 4, radiusMult: 2.0, dmgMult: 2.2 } },
    maxLevel: 1, critModifier: 1.6, tags: ['melee', 'fist'], price: 45, tier: 3, palette: ['#ff5252', '#ffd54f'],
  },
  {
    id: 'gh_reaper', name: '奪魂鬼火', category: 'magic', behavior: 'projectile', charId: 'ghost_shroom', evolvedForm: true,
    description: '幽冥彈的最終形態——貫穿彈道的奪魂火，造成傷害的 25% 化為生命。',
    base: { damage: 32, cooldown: 0.6, range: 420, projectileCount: 1, pierce: 2, knockback: 20, speed: 520 },
    perLevel: {},
    mech: { id: 'lifesteal', params: { pct: 0.25 } },
    maxLevel: 1, critModifier: 1.7, tags: ['magic', 'spore', 'heal'], price: 45, tier: 3, palette: ['#d1c4e9', '#311b92'],
  },
  {
    id: 'lk_storm', name: '雷神連鎖', category: 'magic', behavior: 'chain', charId: 'leek_bolt', evolvedForm: true,
    description: '雷刃的最終形態——一擊在整片敵群間狂跳的雷神連鎖。',
    base: { damage: 26, cooldown: 0.75, range: 400, projectileCount: 1, pierce: 0, knockback: 0, chains: 7, radius: 200 },
    perLevel: {},
    maxLevel: 1, tags: ['lightning', 'magic'], price: 45, tier: 3, palette: ['#fff59d', '#f9a825'],
  },
  {
    id: 'vm_nightwing', name: '夜翼血鐮', category: 'ranged', behavior: 'projectile', charId: 'eggplant_vampire', evolvedForm: true,
    description: '蝠翼鏢的最終形態——雙鐮迴旋、貫穿吸血，造成傷害的 25% 化為生命。',
    base: { damage: 30, cooldown: 0.6, range: 400, projectileCount: 2, pierce: 1, knockback: 30, speed: 660 },
    perLevel: {},
    mech: { id: 'lifesteal', params: { pct: 0.25 } },
    maxLevel: 1, critModifier: 1.8, tags: ['crit', 'heal'], price: 45, tier: 3, palette: ['#ce93d8', '#311b92'],
  },
  {
    id: 'av_collapse', name: '念力崩塌', category: 'magic', behavior: 'projectile', charId: 'avocado_esper', evolvedForm: true,
    description: '念力球的最終形態——強力追蹤、貫穿一整列的空間崩塌波。',
    base: { damage: 32, cooldown: 0.75, range: 420, projectileCount: 1, pierce: 4, knockback: 90, speed: 420 },
    perLevel: {},
    mech: { id: 'homing', params: { turn: 7 } },
    maxLevel: 1, tags: ['magic'], price: 45, tier: 3, palette: ['#dcedc8', '#33691e'],
  },
  {
    id: 'as_tempest', name: '風暴千刃', category: 'melee', behavior: 'melee', charId: 'asparagus_blademaster', evolvedForm: true,
    description: '疾風刃的最終形態——每第 3 刀就是毀滅性的萬刃橫掃。',
    base: { damage: 26, cooldown: 0.3, range: 130, projectileCount: 1, pierce: 99, knockback: 90, radius: 130 },
    perLevel: {},
    mech: { id: 'comboNova', params: { every: 3, radiusMult: 1.9, dmgMult: 2.3 } },
    maxLevel: 1, critModifier: 1.9, tags: ['melee', 'crit'], price: 45, tier: 3, palette: ['#ffffff', '#607d8b'],
  },
  {
    id: 'cg_peacemaker', name: '安魂者左輪', category: 'ranged', behavior: 'projectile', charId: 'corn_gunslinger', evolvedForm: true,
    description: '左輪快槍的最終形態——每第 2 發必暴的高速魔彈。',
    base: { damage: 28, cooldown: 0.38, range: 480, projectileCount: 1, pierce: 1, knockback: 60, speed: 860 },
    perLevel: {},
    mech: { id: 'critEvery', params: { n: 2 } },
    maxLevel: 1, critModifier: 2.0, tags: ['bullet', 'crit'], price: 45, tier: 3, palette: ['#ffe082', '#4e342e'],
  },
  {
    id: 'gp_dawnbringer', name: '破曉聖槌', category: 'melee', behavior: 'melee', charId: 'garlic_paladin', evolvedForm: true,
    description: '聖光槌的最終形態——每一擊都有半數機率把敵人打暈的破曉重槌。',
    base: { damage: 52, cooldown: 0.9, range: 130, projectileCount: 1, pierce: 99, knockback: 220, radius: 140 },
    perLevel: {},
    mech: { id: 'stunHit', params: { chance: 0.5, dur: 1.0 } },
    maxLevel: 1, tags: ['melee', 'support'], price: 45, tier: 3, palette: ['#fff59d', '#ffca28'],
  },
  {
    id: 'ms_myconet', name: '菌網要塞', category: 'engineer', behavior: 'turret', charId: 'mushroom_summoner', evolvedForm: true,
    description: '孢子砲塔的最終形態——射程更遠、火力更猛、佇立更久的菌網要塞。',
    base: { damage: 24, cooldown: 4.5, range: 400, projectileCount: 1, pierce: 0, knockback: 30, speed: 620, duration: 18 },
    perLevel: {},
    maxLevel: 1, tags: ['engineer', 'summon', 'spore'], price: 45, tier: 3, palette: ['#ce93d8', '#4a148c'],
  },
  {
    id: 'pc_eon', name: '永劫時砂', category: 'magic', behavior: 'projectile', charId: 'pitaya_chronos', evolvedForm: true,
    description: '時砂彈的最終形態——貫穿一整列、幾乎凍結時間的永劫時砂。',
    base: { damage: 26, cooldown: 0.7, range: 400, projectileCount: 1, pierce: 3, knockback: 30, speed: 500, slow: 0.75, duration: 3, freezeChance: 0.25 },
    perLevel: {},
    maxLevel: 1, tags: ['magic', 'frost'], price: 45, tier: 3, palette: ['#f8bbd0', '#880e4f'],
  },
  {
    id: 'pa_stormvolley', name: '暴風連弩', category: 'ranged', behavior: 'projectile', charId: 'pea_archer', evolvedForm: true,
    description: '三連弓的最終形態——一次五箭齊射、貫穿成排的暴風連弩。',
    base: { damage: 20, cooldown: 0.55, range: 440, projectileCount: 5, pierce: 2, knockback: 40, speed: 720 },
    perLevel: {},
    maxLevel: 1, critModifier: 1.6, tags: ['bullet', 'spread', 'pierce'], price: 45, tier: 3, palette: ['#a1887f', '#dcedc8'],
  },
]
