...
export const WEAPONS: WeaponData[] = [
  ...
  },
  {
    ...
    description: '緩緩推出的巨型元氣球，命中炸開一大片；對菁英與 Boss 傷害 +40%。',
    base: { damage: 30, cooldown: 1.8, range: 420, projectileCount: 1, pierce: 0, knockback: 120, speed: 320, radius: 130 },
    perLevel: { damage: 12, radius: 10 },
    mech: { id: 'bossKiller', params: { mult: 1.4 } },
    maxLevel: 5, specialEffect: 'explode', tags: ['chi', 'magic', 'explosive'], price: 20, tier: 2, palette: ['#b3e5fc', '#29b6f6'],
  },
  {
  ...
  {
    id: 'cf_jab', name: '連環刺拳', category: 'melee', behavior: 'melee', charId: 'chili_boxer',
    description: '極速的近身連拳；每第 6 拳蓄力轟出橫掃勾拳，範圍與傷害大增。',
    base: { damage: 8, cooldown: 0.34, range: 95, projectileCount: 1, pierce: 99, knockback: 40, radius: 85 },
    perLevel: { damage: 3, cooldown: -0.02, radius: 4 },
    mech: { id: 'comboNova', params: { every: 6, radiusMult: 1.8, dmgMult: 1.6 } },
