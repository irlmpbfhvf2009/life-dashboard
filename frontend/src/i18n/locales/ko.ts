export default {
  ...
  life: {
    ...
    tabs: { todos: '할 일', mood: '기분 일기', finance: '재무 분석', habits: '습관', goals: '목표' },
  },
  portfolio: {
    ...
    projects: {
      ...
      health: { name: '건강·체지방 감량', summary: '"감량 플랜" 중심의 건강 관리 시스템: 템플릿 체크인, 단식 타이머, 체중 추이와 캘린더 내보내기.' },
      casino: { name: '게임 아케이드', summary: '서버 권위형 코인 슬롯머신. 변조 방지 서버 정산을 갖추고 스튜디오 엔터테인먼트 모듈에 내장.' },
    },
  },
  english: {
