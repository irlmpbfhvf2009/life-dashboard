...
export default {
  ...
  theme: {
    extend: {
      colors: {
        // Brand — indigo/violet (fixed; reads well on light & dark)
        brand: {
          50: '#eef2ff',
          100: '#e0e7ff',
          200: '#c7d2fe',
        ...
        // Neutral scale driven by CSS variables so dark mode inverts globally
        // without touching every component (low = surfaces, high = text).
        ink: {
        ...
        // Elevated card surface + page canvas (swap in dark mode)
