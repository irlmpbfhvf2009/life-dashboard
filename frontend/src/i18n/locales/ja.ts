export default {
  ...
  life: {
    ...
    tabs: { todos: 'ToDo', mood: '気分日記', finance: '家計分析', habits: '習慣', goals: '目標' },
  },
  portfolio: {
    ...
    projects: {
      ...
      health: { name: '健康・脂肪減量', summary: '「減量プラン」を軸にした健康管理システム：テンプレートに沿ったチェックイン、断食タイマー、体重推移とカレンダー書き出し。' },
      casino: { name: 'ゲームアーケード', summary: 'サーバー権威のコインスロット。改ざん対策のサーバー精算を備え、スタジオの娯楽モジュールに内蔵。' },
    },
  },
  english: {
