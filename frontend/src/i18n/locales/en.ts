export default {
  ...
  health: {
    ...
    tabs: { today: 'Today', plan: 'Plan', fast: 'Fasting', fitness: 'Fitness', grow: 'Grow' },
    fasting: {
  ...
  life: {
    ...
    tabs: { todos: 'To-dos', mood: 'Mood journal', finance: 'Finance', habits: 'Habits', goals: 'Goals' },
  },
  portfolio: {
    ...
    projects: {
      ...
      health: { name: 'Health & Fat-loss', summary: 'A training-plan-driven fitness tracker: template workout/meal check-ins, a fasting timer, weight trends and calendar export.' },
