...
export const CHEST_BOONS: ChestBoonData[] = [
  ...
  { id: 'boon_flat', name: '泰坦拳套', detail: '固定攻擊力 +8（永久）', weight: 9, statMods: { flatDamage: 8 } },
  { id: 'boon_leech', name: '吸血鬼獠牙', detail: '吸血 +5%（永久，上限 50%）', weight: 8, statMods: { lifesteal: 0.05 } },
  { id: 'boon_dr', name: '守護石', detail: '傷害減免 +8%（永久，上限 50%）', weight: 8, statMods: { damageReduction: 0.08 } },
